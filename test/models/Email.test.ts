...
describe("Email", () => {
  ...
  describe("createEmail", () => {
    it("should create a new email", async () => {
      ...
      (api.makeApiCall as jest.Mock).mockResolvedValue(emailMock);
  ...
  describe("sendEmail", () => {
    it("should send an email", async () => {
      (api.makeApiCall as jest.Mock).mockResolvedValue(emailReqMock);
  ...
  describe("get", () => {
    it("should get an email by id", async () => {
      ...
      expect(api.makeApiCall).toHaveBeenCalledWith("get", "v1/emails/1");
      expect(result).toEqual(emailMock);
  ...
  describe("delete", () => {
    it("should delete an email by id", async () => {
      ...
      expect(api.makeApiCall).toHaveBeenCalledWith("delete", "v1/emails/1");
